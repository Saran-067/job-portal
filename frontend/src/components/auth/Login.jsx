    ...
    useEffect(() => {
        const checkAuth = async () => {
            try {
                ...
                dispatch(setUser(res.data.user));  // ✅ Store user in Redux if authenticated
            } catch (error) {
                dispatch(setUser(null));  // ✅ Ensure no stale user data
            }
        };

        if (!user) checkAuth();  // ✅ Only check if no user is in Redux
    }, [user, dispatch]);
