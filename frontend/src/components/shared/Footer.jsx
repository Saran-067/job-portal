...
const Footer = () => {
  return (
    <footer className="bg-black text-white border-t border-t-gray-800 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job <span className="text-[#F83002]">hook</span></h2>
            <p className="text-sm text-gray-400">ADL GROUP PROJECT</p>
          </div>
